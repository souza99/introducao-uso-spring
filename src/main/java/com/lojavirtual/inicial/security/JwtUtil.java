package com.lojavirtual.inicial.security;
...
public class JwtUtil {
    ...
    public String gerarTokenUsername(Pessoa object) {
        return Jwts.builder().setSubject(object.getUsername()).setIssuedAt(new Date())
